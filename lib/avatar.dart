...
class _AvatarCardState extends State<AvatarCard> {
  ...
  Widget layoutCard(BuildContext context, double sizeWidthPhoto,
      String imageBgUrl, double addFontSize) {
    return Container(
      decoration: BoxDecoration(
          image: DecorationImage(
        fit: BoxFit.cover,
        image: AssetImage(imageBgUrl.toString()),
      )),
      child: Scaffold(
        backgroundColor: Colors.transparent,
        body: Stack(
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontWeight: FontWeight.bold,
                                      color:
                                          const Color.fromARGB(255, 145, 5, 5),
                                    ),
                                  ),
                                ),
                              ),
  ...
  Widget foldLayoutCard(BuildContext context, double sizeWidthPhoto,
      String imageBgUrl, double addFontSize) {
    return TwoPane(
      startPane: Container(
        decoration: BoxDecoration(
      ...
      // panePriority: MediaQuery.of(context).size.width > 600
